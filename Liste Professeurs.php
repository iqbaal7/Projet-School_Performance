...
<!-- Lien CSS -->
<link type="text/css" href="./teacherprojet.css" rel="stylesheet">
...
<!-- Navbar vertical-->
    ...
    <h2 class="listprof"> Liste Professeurs</h2>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">  Ajouter Professeurs</h5>
      ...
      <div class="modal-body">
        ...
        <form>
          ...
          <input type="text" id="adress" name="address" placeholder="Adress">
          <br><br>
